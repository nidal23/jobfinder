...
const Search = () => {
  return (
    <div className='searchDiv grid gap-10 bg-gray-100 rounded-[10px] p-[3rem]'>
      <form action="">
        <div className='firstDiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-gray-300'>
          ...
          <button className=' bg-teal-500 h-full p-5 px-10 rounded-[10px] text-white cursor-pointer hover:bg-teal-300 '>Search</button>
        </div>
      </form>
      <div className='secDiv flex items-center gap-10 justify-center'>
        <div className='sengleSearch flex items-center gap-2'>
