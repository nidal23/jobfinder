...
const Footer = () => {
  return (
    <div className='footer p-[5rem] mb-4 bg-teal-500 rounded-[10px] gap-[8] grid grid-cols-5 m-auto items-center justify-center'>
      <div>
      ...
      <p className='text-white pb-[13px] opacity-70 leading-7'>
        We make sure our seekers and companies find the best employers find the best candidates.
      </p>
      </div>
      ...
      <div className='grid'>
        ...
        <small className='text-[14px] text-white'>jobfinder@gmail.com</small>
        <div className='icons flex gap-4 py-[1rem]'>
          <AiOutlineInstagram className='bg-white p-[10px] h-[35px] w-[35px] rounded-full icon text-teal-500'/>
          <AiOutlineTwitter className='bg-white p-[10px] h-[35px] w-[35px] rounded-full icon text-teal-500'/>
          <AiOutlineFacebook className='bg-white p-[10px] h-[35px] w-[35px] rounded-full icon text-teal-500'/>
        </div>
      </div>
